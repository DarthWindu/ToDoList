	...
	public EditActionItem(Task task)
	{
		...
		dialog.addWindowListener(new WindowListener()
		{
			...
			public void windowClosed(WindowEvent e) {
				...
				tasker.storeDate(new Date(Integer.parseInt(CurrentMonth.getText()),Integer.parseInt(CurrentDay.getText()), Integer.parseInt(CurrentYear.getText())), 1);

			}

			public void windowClosing(WindowEvent e) {
				if (Integer.parseInt(CurrentMonth.getText())>31 || Integer.parseInt(CurrentDay.getText())-1>11 || Integer.parseInt(CurrentYear.getText())+1900 <2016)
				{
					System.exit(ABORT);
				}
